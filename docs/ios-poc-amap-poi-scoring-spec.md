...
`name` 和 `type` 是辅助证据，不是最终事实。关键词分为**强功能词**、**弱补证词**和**容器词**。

### 7.1 强功能词

强功能词可以在缺少 typecode 时生成 name-only 候选，但候选仍受低置信 cap 约束；在有 typecode/regeo 同向证据时，强功能词可以提供功能词加分。

| 内部 `place_type` | name/type 强关键词 |
|---|---|
| `住宅区` | 小区、公寓、学生公寓、宿舍、学生宿舍、宿舍楼、寝室、生活区、家属院、家属区、居民楼、住宅楼、家属楼、家园、住宅、苑、楼栋、楼座、apartment、residence、residential、dormitory |
| `写字楼` | 写字楼、办公、办公楼、商务楼、商务中心、软件园、创意园、工业园、办公区、企业园区、孵化器、科技园、产业园、联合办公、总部、office、office building、business center、coworking |
| `餐厅` | 餐厅、饭店、饭馆、餐馆、酒楼、餐饮、面馆、粉店、食堂、茶餐厅、西餐厅、咖啡馆、咖啡店、甜品店、小吃、菜馆、烤肉、酒吧、咖啡、茶饮、火锅、烧烤、料理、restaurant、cafe、coffee、canteen、bistro |
| `商场` | 商场、商城、购物中心、购物广场、商业广场、商业中心、奥特莱斯、综合体、百货、商业街、shopping mall、shopping center、department store、outlets、mall |
| `酒店` | 酒店、宾馆、旅馆、公寓酒店、酒店式公寓、服务公寓、度假村、招待所、青年旅舍、民宿、客栈、hotel、hostel、inn、resort、motel |
| `公园` | 公园、运动公园、体育公园、森林公园、湿地公园、郊野公园、植物园、生态园、风景区、绿地、湿地、景区、national park、botanical garden、park |
| `图书馆` | 图书馆、阅览室、library |
| `运动场所` | 体育馆、体育场、操场、运动场、球场、健身房、健身、游泳馆、瑜伽馆、羽毛球馆、篮球馆、足球场、瑜伽、羽毛球、篮球、足球、gym、fitness、stadium |
| `地铁站` | 地铁站、轨交站、subway station、metro station、subway、metro |
| `高铁站` | 高铁站、火车站、铁路站、动车站、高铁、train station、railway station |
| `机场` | 机场、航站楼、候机楼、登机口、airport、airport terminal |
| `海边` | 海边、海滩、沙滩、码头、滨海、海岸、beach、marina、seaside、coast |
| `在途` | 公交、公交站、汽车站、客运站、车站、station、transit |

### 7.2 弱补证词

弱补证词不主动 query，也不单独生成高置信地点；name-only 弱词候选应过滤或保持不可用。只有在已有 typecode/regeo/强功能词同向时，弱词才提供小幅补证或低 cap 解释。

| 内部 `place_type` | name/type 弱关键词 |
|---|---|
| `住宅区` | 花园、社区、新村 |
| `商场` | 广场 |
| `图书馆` | 书店、书城、自习室 |
| `写字楼` | 大厦、中心、公司、研究院、学校、大学、学院、园区 |
| `海边` | 湾、港、滨江、滨河 |
| `地铁站` | 地铁口、地铁出口、换乘站 |
| `高铁站` | 站前广场、候车厅 |

例如：`市民广场` 不 name-only 判 `商场`，`购物广场` 可以；`小花园` 不 name-only 判 `公园`，`湿地公园/运动公园` 可以；`书店/自习室` 不 name-only 判 `图书馆`，`图书馆/阅览室` 可以；`滨江/滨河` 不 name-only 判 `海边`，`海滩/滨海/码头` 可以。
...
科技园、产业园按强 `写字楼` 功能词处理；泛 `园区` 仍是弱容器词，不直接等于高置信写字楼。

处理：

- 如果 building/POI 命中科技园、产业园、公司、办公楼、总部，输出 `写字楼`。
